...
export default function ChatHistory({ onSelectChat, onNewChat }: ChatHistoryProps) {
  ...
  return (
    <Card className="h-full flex flex-col bg-gradient-to-br from-white/95 to-slate-50/95 border border-white/20 shadow-2xl backdrop-blur-xl overflow-hidden">
      {/* Header */}
      <motion.div 
      ...
      {/* Chat List */}
      <ScrollArea className="flex-1 bg-gradient-to-b from-white/50 to-slate-50/30">
