...
export default function ContractGenerator({ onBack }: ContractGeneratorProps) {
  ...
  return (
    <div className="h-full flex flex-col" style={{ height: '100%', maxHeight: 'calc(100vh - 100px)' }}>
      {/* Header */}
      <motion.div 
      ...
      <div className="flex-1 grid grid-cols-12 gap-6 p-6 bg-gradient-to-br from-slate-50 to-white overflow-y-auto scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent hover:scrollbar-thumb-slate-400 pb-8" style={{ scrollBehavior: 'smooth', height: '100%', maxHeight: 'calc(100vh - 200px)' }}>
        {/* Template Selection */}
        <motion.div 
