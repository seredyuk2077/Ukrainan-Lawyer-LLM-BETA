...
async function main(): Promise<void> {
  ...
  console.log('[verify_retrieval_real_dev] port', port, 'DEV cases', dev.length);
  ...
  const hardFailCount = total - passed - softFailCount;
  const hardPass = passed;
  ...
  console.log('hard_pass:', hardPass, 'soft_fail:', softFailCount, 'hard_fail:', hardFailCount);
  console.log('% act_family_hit:', actFamilyHitPct);
  console.log('% act_list_hit:', actFamilyHitPct);
