...
export const RetrievalTraceSchema = z.object({
  ...
  meta: z
    .object({
      ...
      exact_act_hit_count: z.number().int().min(0).optional(),
      exact_act_nregs: z.array(z.string()).optional(),
      grounded_act_hit_count: z.number().int().min(0).optional(),
      grounded_act_nregs: z.array(z.string()).optional(),
