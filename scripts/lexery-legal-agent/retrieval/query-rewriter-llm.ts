...
ПРАВИЛО СУБСТАНТИВНИХ ВАРІАНТІВ (обов'язково!): якщо запит містить явні посилання на статті закону (наприклад "ст. 121 КК України", "ст. 119 КК"), ТО query_variants[0] (ПЕРШИЙ варіант) ОБОВ'ЯЗКОВО має описувати ЗМІСТ цих статей — диспозицію, склад злочину/правопорушення, санкцію, елементи. НЕ апеляційні процедури, НЕ процесуальні дії. Приклад: якщо запит містить "ст.121 ч.2 КК" та "ст.119 ч.1 КК", то перший варіант має бути типу: "умисне тяжке тілесне ушкодження що спричинило смерть потерпілого диспозиція санкція суб'єктивна сторона умисел необережне вбивство складу злочину відмінність відмежування".
Пояснення: запит "апеляційна скарга" знайде КПК, а запит "умисне тяжке тілесне ушкодження смерть" знайде кримінальний кодекс з правильними статтями. Без субстантивного варіанту кримінальний кодекс не буде знайдений.
ПРАВИЛО МУЛЬТИ-АСПЕКТНИХ ВАРІАНТІВ (обов'язково!): якщо запит стосується правового явища/ситуації, що породжує наслідки у 2+ РІЗНИХ правових сферах — ОБОВ'ЯЗКОВО генеруй окремий query_variant для кожної додаткової правової сфери. Ознаки мульти-аспектності: дія одночасно регулюється і цивільним, і трудовим правом; запит містить і "відповідальність", і "органи/підслідність"; запит торкається і матеріального складу, і процедури/порядку. НЕ згадуй конкретні назви актів або rada_nreg.
Приклади: "емансипація неповнолітнього" → variant[0]: "укладення трудового договору неповнолітній самостійно право на зайнятість трудові відносини обмежена дієздатність", variant[1]: "підприємницька діяльність неповнолітній правочини цивільна правоздатність дієздатність майнові права". "корупційне правопорушення + розслідування" → variant[0]: "підслідність органи досудового розслідування антикорупційні органи прокуратура повноваження детектив", variant[1]: "склад корупційного правопорушення відповідальність санкція визначення корупція". "порушення кордону + відповідальність" → variant[0]: "незаконне перетинання державного кордону кримінальна відповідальність склад правопорушення санкція", variant[1]: "адміністративна відповідальність порушення режиму державного кордону процедура". Без цих варіантів пошук пропустить акти з вторинних правових сфер, критично важливих для повної відповіді writer-у.
